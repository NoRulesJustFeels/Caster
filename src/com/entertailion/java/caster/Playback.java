...
public class Playback {
	...
	public Playback(Platform platform, String appId, DialServer dialServer, PlaybackListener playbackListener) {
		...
		this.rampClient = new RampClient(playbackListener);
	}
	...
	public void play(final String file, final boolean isTranscoding) {
		if (isTranscoding) {
			...
			mediaPlayer.addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
				...
				public void playing(MediaPlayer mediaPlayer) {
					...
					playbackListener.updateDuration(rampClient, (int) (mediaPlayer.getLength() / 1000.0f));
				}
		...
		if (address != null) {
			...
			final RampClient rampClient = new RampClient(new PlaybackListener() {
				private int time;
				...
				private void stop(RampClient rampClient) {
					rampClient.stop();
					if (!isTranscoding) {
						embeddedServer.stop();
					} else {
